...
import { RotateCw, ZoomIn, ZoomOut, Eye, MapPin, Camera, Satellite, Cloud, AlertTriangle, Lightbulb } from 'lucide-react';
  ...
  const earthBenefits = [
    {
      ...
      description: 'Advanced imaging techniques refined through Cupola observations improve Earth monitoring satellites.',
    },
    {
      icon: AlertTriangle,
      title: 'Disaster Monitoring',
      description: 'Real-time disaster assessment capabilities help coordinate emergency response efforts worldwide.',
    },
    {
      icon: Cloud,
      title: 'Climate Research',
      description: 'Atmospheric and oceanic observations contribute to climate models and weather prediction.',
    },
  ];

  const gallery = [
    { id: 1, url: 'https://images.unsplash.com/photo-1722850998715-91dcb2b7d327?w=400' },
    { id: 2, url: 'https://images.unsplash.com/photo-1685427454855-8291928a6d7d?w=400' },
    { id: 3, url: 'https://images.unsplash.com/photo-1636565214233-6d1019dfbc36?w=400' },
    { id: 4, url: 'https://images.unsplash.com/photo-1688413399498-e35ed74b554f?w=400' },
  ];
      ...
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground text-lg max-w-3xl mx-auto">
            The most stunning window to Earth, offering astronauts a 360-degree view of our planet 
              ...
              <div className="relative aspect-square bg-gradient-to-br from-background to-accent rounded-lg overflow-hidden border-2 border-border">
                ...
                <div className="absolute bottom-4 left-4 right-4 bg-background/80 backdrop-blur-sm rounded-lg p-3 text-sm">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[#0B3D91] font-semibold">Rotation: {rotation}° | Zoom: {zoom.toFixed(1)}x</span>
                  </div>
                </div>
              </div>

              <p className="text-sm text-muted-foreground">
                Use the controls above to rotate and zoom the Cupola model. The Cupola module provides 
                astronauts with a panoramic view of Earth and is used for observing and guiding robotic operations.
              </p>
            </Card>
              ...
              <DialogContent>
                ...
                <div className="space-y-4 text-sm">
                  <div className="space-y-2">
                    <h4 className="font-semibold">Most Photographed Location</h4>
                    <p className="text-muted-foreground">
                      The Cupola is the most photographed location on the ISS, capturing hundreds of 
                      thousands of images of Earth for scientific research and public engagement.
                    </p>
                  </div>
                  <div className="space-y-2">
                    <h4 className="font-semibold">Built in Italy</h4>
                    <p className="text-muted-foreground">
                      The Cupola was manufactured by the European Space Agency in Turin, Italy, and 
                      launched to the ISS on Space Shuttle Endeavour in 2010.
                    </p>
                  </div>
                  <div className="space-y-2">
                    <h4 className="font-semibold">Robotic Control Center</h4>
                    <p className="text-muted-foreground">
                      Beyond observation, the Cupola serves as the primary control station for the ISS 
                      robotic arm, crucial for capturing visiting spacecraft and conducting repairs.
                    </p>
                  </div>
                </div>
              </DialogContent>
        ...
        <div className="space-y-6">
          <div className="text-center">
            ...
            <p className="text-muted-foreground mt-2">
              Technologies and insights from the Cupola module improve life on our planet
            </p>
          </div>
